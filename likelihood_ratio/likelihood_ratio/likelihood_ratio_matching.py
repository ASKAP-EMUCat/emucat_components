##Originally written by Leah Morabito (https://github.com/lmorabit/likelihood_ratio)
##for use with LoTSS
##Adapted by Yjan Gordon for CIRADA (cirada.ca) to use with VLASS and EMU
...
def LR_and_reliability( band, band_dat, radio_dat, qm_nm, sigma_pos, mag_bins, r_max, q0, outdir, LR_threshold=0.8,
    ...
    outfile = os.path.join(outdir, band + '_LR_matches.csv')
